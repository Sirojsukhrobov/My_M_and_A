...
def first_ds(param_1):
    if len(param_1.getvalue()) > len('only_wood_customer_us_1.csv'):
...
if __name__ == '__main__':
    merged_csv = my_m_and_a(StringIO('only_wood_customer_us_1.csv'), StringIO('only_wood_customer_us_2.csv'), StringIO('only_wood_customer_us_3.csv')).to_csv(index=False)
